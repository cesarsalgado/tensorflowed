...
from tensorflowed.data import Dataset, TrainTestDatasets
...
def mnist_train_test_datasets_getter():
  ...
  train = Dataset(datasets.train.images.reshape(n_samples, side, side, 1),
                  datasets.train.labels)
  n_samples, n_dims = datasets.test.images.shape
  test = Dataset(datasets.test.images.reshape(n_samples, side, side, 1),
...
def set_params_and_run01():
  ...
  params[
      'train_test_datasets_getter'] = lambda: mnist_train_test_datasets_getter()
